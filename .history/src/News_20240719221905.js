...
export class News extends Component {
   articles = [{
    ...
    "description": "The mining of technology nostalgia is unrelenting. Earlier this week, we had an unofficial return of the iPod, not to mention Tamagotchis and now Discman. Well, not an actual Discman, which is a Sony brand, but the portable CD player is back.\nAudiophile brand…",
    ...
    <div className='container my-3'>
        ...
        {this.state.articles.map((element)=>{
          <div className="col-md-4">
              ...
              imageurl="https://images.macrumors.com/t/V-BW71L5EjFdoafu8GjXL9Hxh0U=/1920x/article-new/2023/08/bsod-16-9.jpg"/>
          </div>
