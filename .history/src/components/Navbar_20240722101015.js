  ...
  render() {
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
           ...
           <li className="nav-item dropdown"><Link to="/About"className="nav-link " >About</Link></li>
           <li className='nav-item dropdown'><Link to="/Buisness" className="nav-link">Buisness</Link></li>
