...
export class News extends Component {
  ...
  render() {
    ...
    <div className='container my-3'>
        ...
        <button type="button" class="btn btn-success class=" onClick={handlePrevClick}>&larr; previous</button>
        <button type="button" class="btn btn-info" onClick={handleNextClick}>More Info &rarr;</button>
        </div>
    </div>
    )
  }
