...
export class News extends Component {
   ...
   async componentDidMount(){
      let url=`https://newsapi.org/v2/everything?q=tesla&from=2024-06-19&sortBy=publishedAt&category=${this.props.category}&apiKey=f0f3bf5d2db44fd583713070908f27e9&page=1&pagesize=${this.props.pageSize}`;
   ...
   handlePrevClick = async ()=>{
      console.log("previ");
      let url=`https://newsapi.org/v2/everything?q=tesla&from=2024-06-19&sortBy=publishedAt&category=${this.props.category}&apiKey=f0f3bf5d2db44fd583713070908f27e9&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
      let data = await fetch(url);
      let parseData = await data.json()
      console.log(parseData);
      this.setState({
